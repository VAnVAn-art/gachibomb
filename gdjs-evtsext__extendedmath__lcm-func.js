...
gdjs.evtsExt__ExtendedMath__Lcm.userFunc0x2112f38 = function GDJSInlineCode(runtimeScene, eventsFunctionContext) {
"use strict";
function gcf(a, b) {
    while (a != b) {
        if (a > b) {
...
gdjs.evtsExt__ExtendedMath__Lcm.userFunc0x2112f38(runtimeScene, eventsFunctionContext);
